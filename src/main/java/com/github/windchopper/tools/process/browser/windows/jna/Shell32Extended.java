...
public interface Shell32Extended extends Shell32 {
    ...
    Shell32Extended INSTANCE = (Shell32Extended) Native.loadLibrary("shell32", Shell32Extended.class, W32APIOptions.UNICODE_OPTIONS);
    ...
    Pointer CommandLineToArgvW(Pointer cmdline, IntByReference sz);
